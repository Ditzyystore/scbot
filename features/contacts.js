    ...
    case "sv":
      ...
      if (isGroup) {
        logger(
          "error",
          "SAVE",
          "KHUSUS CHAT PRIVATE BANG WDWANGSAF"
        );
        return replyCommand(
          `KHUSUS CHAT PRIVATE BANG WDWANGSAF`
        );
        ...
        try {
          if (!text) {
            logger(
              "error",
              "SAVE",
              "Command salah contohnya .save WDWANGSAF atau nama bebas setelah itu akan di kirim kontak"
            );
            return replyCommand(
              `Command salah contohnya .save WDWANGSAF atau nama bebas setelah itu akan di kirim kontak`
            );
    ...
    case "skv1":
      ...
      if (!text) {
        logger(
          "error",
          "savekontakuser",
          `command yang anda masukan salah contohnya .savekontakuser gathann ganti nama kalian untuk merubah nama save`
        );
        return replyCommand(
          `command yang anda masukan salah contohnya .savekontakuser WDWANGSAF ganti nama kalian untuk merubah nama save`
        );
      }
    ...
    case "skv2":
      ...
      if (!text) {
        logger(
          "error",
          "savekontakgc",
          `command yang anda masukan salah contohnya .savekontakgc WDWANGSAF ganti nama kalian untuk merubah nama save`
        );
        return replyCommand(
          `command yang anda masukan salah contohnya .savekontakgc WDWANGSAF ganti nama kalian untuk merubah nama save`
        );
    ...
    case "skv3":
      ...
      if (!text || !text.split("|")[0] || !text.split("|")[1]) {
        logger(
          "error",
          "savekontakid",
          `command yang anda masukan salah contohnya .savekontakid id|WDWANGSAF ganti nama kalian untuk merubah nama save`
        );
        return replyCommand(
          `command yang anda masukan salah contohnya .savekontakid id|WDWANGSAF ganti nama kalian untuk merubah nama save`
        );
