    ...
    case "pushkontakuser":
      ...
      if (!text) {
        logger(
          "error",
          "pushkontakuser",
          `Perintah salah contoh .pushkontakuser WDWANGSAF ganti dengan text masing-masing`
        );
        return replyCommand(
          `Perintah salah contoh .pushkontakuser WDWANGSAF ganti dengan text masing-masing`
        );
      ...
      try {
        if (!text || !text.split("|")[0] || !text.split("|")[1]) {
          logger(
            "error",
            "pushkontakid",
            `Perintah salah contoh .pushkontakid id|WDWANGSAF ganti dengan text masing-masing`
          );
          return replyCommand(
            `Perintah salah contoh .pushkontakid id|WDWANGSAF ganti dengan text masing-masing`
          );
