    ...
    case "broadcastuser":
      ...
      if (!text) {
        logger(
          "error",
          "broadcastuser",
          `Perintah salah contoh .broadcastuser WDWANGSAF ganti dengan text masing-masing`
        );
        return replyCommand(
          `Perintah salah contoh .broadcastuser WDWANGSAF ganti dengan text masing-masing`
        );
      ...
      if (!isGroup) {
        ...
        if (!text) {
          logger(
            "error",
            "broadcastgc",
            `Perintah salah contoh .broadcastgc WDWANGSAF ganti dengan text masing-masing`
          );
          return replyCommand(
            `Perintah salah contoh .broadcasgc WDWANGSAF ganti dengan text masing-masing`
          );
        }
        try {
    ...
    case "broadcastid":
      ...
      if (!text || !text.split("|")[0] || !text.split("|")[1]) {
        logger(
          "error",
          "broadcastid",
          `Perintah salah contoh .broadcastid id|WDWANGSAF ganti dengan text masing-masing`
        );
        return replyCommand(
          `Perintah salah contoh .broadcastid id|WDWANGSAF ganti dengan text masing-masing`
        );
